...
namespace Client_Module.ViewsTagID.Layout
{
    public static class LayoutTagID
    {
        public static string NavHomeBtnID { get; } = "home-btn";
        public static string NavAccountBtnID { get; } = "account-btn";
