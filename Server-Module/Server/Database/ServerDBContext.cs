        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            if (_addSeeding)
            {
                modelBuilder.Entity<ClientDb>().HasData(
                    ...
                    new ClientDb { ClientID = -2, Username = "client2", Email = "client2", Name = "TestNameX", Surname = "TestSurnameX", Password = "client2" },
                ...
                modelBuilder.Entity<HotelDb>().HasData(
                    new HotelDb { HotelID = 99999999, City = "TestCity0", Country = "TestCountry0", HotelDescription = "TestHotelDesc0", AccessToken = "{\"id\":99999999,\"createdAt\":\"2021-05-11T18:21:50Z\"}", HotelName = "TestHotelName0", HotelPreviewPicture = "TestHotelPreviewPicture0" },
                    new HotelDb { HotelID = 99999998, City = "TestCityX", Country = "TestCountryX", HotelDescription = "TestHotelDescX", AccessToken = "{\"id\":99999998,\"createdAt\":\"2021-05-11T18:21:50Z\"}", HotelName = "TestHotelNameX", HotelPreviewPicture = "TestHotelPreviewPictureX" },
