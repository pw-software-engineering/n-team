        ...
        private void Seed()
        {
            using (var transaction = _context.Database.BeginTransaction())
            {
                ...
                _context.ClientReservations.AddRange(
                    ...
                    new ClientReservationDb { ReservationID = 3, OfferID = 3, ClientID = 1, HotelID = 3, RoomID = 3, ReviewID = null, NumberOfAdults = 1, NumberOfChildren = 2, FromTime = new DateTime(3001, 3, 3), ToTime = new DateTime(3001, 3, 6) });
                _context.SaveChanges();
